...
import type { MonthCoverage as CoverageResult } from "@/lib/domain/coverage";
import { parseDateKey, weekKeyOf } from "@/lib/domain/week";
 ...
 */
export function MonthCoverage({ coverage }: { coverage: CoverageResult | null }) {
  const { setWeekKey, addDay } = useTimesheet();
